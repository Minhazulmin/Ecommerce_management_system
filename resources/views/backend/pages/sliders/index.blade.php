...
@section('content')
  <div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="card">
        <div class="card-header text-center head_color_sli">
          MANAGE ALL SLIDERS
        </div>
        <div class="card-body">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="{!! route('admin.slider.store') !!}"  method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="button_text">Slider Button Text <small class="text-danger">(required)</small></label>
                        <input type="text" class="form-control" name="button_text" id="button_text" placeholder="Slider Button Text (if need)">
                      </div>

                      <div class="form-group">
                        <label for="button_link">Slider Button Link <small class="text-danger">(required)</small></label>
          ...
          <table class="table table-hover table-striped mshadow">
            ...
            @foreach ($sliders as $slider)
              <tr>
                ...
                <td>{{ $slider->title }}</td>
                <td>
                  <img src="{{ asset('images/slider/'.$slider->image) }}" width="40">
                </td>
                ...
                <td>
                  ...
                  <a href="#deleteModal{{ $slider->id }}" data-toggle="modal" class="btn btn-danger"><i class="fa fa-trash-o mr-0 text-white"></i></a>
