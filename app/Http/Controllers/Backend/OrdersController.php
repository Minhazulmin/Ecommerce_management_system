...
class OrdersController extends Controller
{
    ...
    public function allgenerateInvoice()
    {
        $orders = Order::orderby('id','desc')->get();
       // return view('backend.pages.orders.all_invoice', compact('orders'));
        $pdf = PDF::loadView('backend.pages.orders.all_invoice', compact('orders'));
        return $pdf->stream('all_invoice.pdf');
